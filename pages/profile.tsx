...
const Profile = () => {
    ...
    const updateProfile = async (values : any ) => {
        // await updateDoc(profileData,values)
    }
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            updateProfile(values).then(() => notifySuccess('Updated Profile Successfully')).catch(() => notifyError("Ann error occured while updating profile details"))
        }
    })
