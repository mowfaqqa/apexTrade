...
const Bitcoin = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto'>
        ...
        <p className='px-2'>To make payment from your trading account please use our wallet address above and click on <span className='text-orange-500'>Make payment</span></p>
        <div>
